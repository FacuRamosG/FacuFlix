...
export const MediaReview = ({ reviews, media, mediaType }) => {
  const { user } = useSelector((state) => state.user)
  ...
  const [reviewCount, setRevirewCount] = useState(0)
  ...
  useEffect(() => {
    ...
    setRevirewCount(reviews.length > 0 ? reviews.length : 0)
  }, [reviews])
